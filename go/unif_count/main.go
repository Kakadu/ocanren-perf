...
var cases = []countCase{
	...
	{"logo2base2", 52, 52, false, func() int64 { c, _ := bench.Logo(2, 2, 1); return c }},
	{"logo3base2", 168, 168, false, func() int64 { c, _ := bench.Logo(3, 2, 1); return c }},
	{"logo4base2", 164, 164, false, func() int64 { c, _ := bench.Logo(4, 2, 1); return c }},
	{"logo3base3", 75, 75, false, func() int64 { c, _ := bench.Logo(3, 3, 1); return c }},
	{"logo4base3", 7777, 7777, false, func() int64 { c, _ := bench.Logo(4, 3, 1); return c }},
	{"logo5base2", 600, 600, false, func() int64 { c, _ := bench.Logo(5, 2, 1); return c }},
	{"logo8base2", 204, 204, false, func() int64 { c, _ := bench.Logo(8, 2, 1); return c }},
	{"logo243base3", 56264, 56264, true, func() int64 { c, _ := bench.Logo(243, 3, 1); return c }},
